...
//             "teamAScore"
//           ).textContent = `Total Score for Team A: ${teamAPoints}`;
//         }
//       } else {
...
//           document.getElementById(
//             "teamBScore"
//           ).textContent = `Total Score for Team B: ${teamBPoints}`;
//         }
//       }
//     }
...
//         document.getElementById(
//           "teamATimeouts"
//         ).textContent = `Timeouts for Team A: ${teamATimeouts}`;
//       } else {
//         teamB.timeouts += 1; // Increment timeouts for Team B
//         document.getElementById(
//           "teamBTimeouts"
//         ).textContent = `Timeouts for Team B: ${teamBTimeouts}`;
//       }
//     }
//   }
//   return {
